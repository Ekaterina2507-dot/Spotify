...
<div class="searchContainer">
    ...
    <label>
        <input type="text" class="searchInput" value="<?php echo $term; ?>" placeholder="What do you want to play?"
			...
			while ($row = mysqli_fetch_array($songsQuery)) {
				...
				echo "<li class='trackListRow'>
						<div class='trackCount'>
							<img class='play' src='Includies/3/img/icons/play-white.png' onclick='setTrack(\"" . $albumSong->getId() . "\", tempPlaylist, true)'>
